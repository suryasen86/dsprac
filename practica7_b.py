...
#1st test case
hash_table.__setitem__(11804562,"Dhanush")
print(hash_table._find_item(11804562))
print(hash_table.__getitem__(11804562))

#2nd
hash_table.__setitem__(11804573,"Sravan")
print(hash_table._find_item(11804573))
print(hash_table.__getitem__(11804573))

#3rd
hash_table.__setitem__(11804584,"Omeswar")
